...
STATES = {
    ...
    "TX": {
        ...
        "vintage": "Harris/Dallas/Travis/Collin/Fort Bend/Cameron (2024–2026)",
        "source": "Per-county appraisal districts — Harris, Dallas, Travis, Collin, Fort Bend, Cameron (more rolling in)",
        "available": {
